...
type DirectiveRoot struct {
	HasRole func(ctx context.Context, obj interface{}, next graphql.Resolver, role models_gen.Role) (res interface{}, err error)
}
...
type MutationResolver interface {
	...
	SingleUpload(ctx context.Context, file graphql.Upload) (*models_gen.File, error)
}
type QueryResolver interface {
	Todos(ctx context.Context) ([]*models_gen.Todo, error)
	User(ctx context.Context) (*models_gen.User, error)
}
...
func (ec *executionContext) _Todo_user(ctx context.Context, field graphql.CollectedField, obj *models_gen.Todo) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _User_name(ctx context.Context, field graphql.CollectedField, obj *models_gen.User) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _User(ctx context.Context, sel ast.SelectionSet, obj *models_gen.User) graphql.Marshaler {
